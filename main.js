...
//=============================================================================
  ...
  // b - we need function to add the other info for the pet, called addInfo function.

  // pet1.addInfo(age, owner, gender, species, availability);

  // c- create another function to increase the pet age by n value.

  // d - we need another function to check the pet state, if the pet is available it should return true , if not it should return false.
  //     note that the default state of the pet is false.
